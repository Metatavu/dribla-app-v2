...
import 'package:dribla_api/src/serializers.dart';
import 'package:dribla_api/src/auth/api_key_auth.dart';
...
class DriblaApi {
  ...
  GameSessionsApi getGameSessionsApi() {
    return GameSessionsApi(dio, serializers);
  }
